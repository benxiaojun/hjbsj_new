  ...
  $ionicPlatform.ready(function() {
    ...
    function onOffline() {
      ...
      $ionicPlatform.registerBackButtonAction(function (e) {
        ...
        //判断处于哪个页面时双击退出
        if ($location.path() == '/allAppointment'||$location.path() == '/login'||$location.path() == '/newAddedCustomer'||$location.path() == '/hcMainOrder') {
  ...
  // setup an abstract state for the tabs directive
    ...
    controller: 'allAppointmentCtrl'
      ...
      .state('yuyue_expand_detail',{
        ...
        templateUrl: 'templates/yuyue_expand_detail.html',
      ...
      .state('kanchang_expand_detail',{
        ...
        templateUrl: 'templates/kanchang_expand_detail.html',
        params:{yanghuiting_list:null,item:null},
        controller: 'kanchang_expand_detail_ctrl'
      })
      .state('kanchang_chaidan',{
        url:'/kanchang_chaidan/:id',
        templateUrl:'templates/kanchang_chaidan.html',
      ...
      .state('show_yuding_detail', {
        url:'/show_yuding_detail/',
        params:{id:null,wtype:null},
    ...
    .state('all_yuyue_order',{
      templateUrl:'templates/allYuyueOrder.html',
      controller:'allYuyueOrderCtrl'
    })
    .state('jdCanceledOrders',{
      url:'/jdCanceledOrders',
      templateUrl:'jdCanceledOrders.html',
      controller:'jdCanceledOrdersCtrl'
    })
      .state('show_canceled_yuyue_detail', {
        url:'/show_canceled_yuyue_detail/',
        params:{id:null},
        templateUrl: 'templates/show_canceled_yuyue_detail.html',
        controller:'canceledYuyueDetailCtrl'
      })
    .state('all_yuding_order',{
    templateUrl:'templates/allYudingOrder-tabs.html',
    //params:{yanghuiting_count:null,yanghuiting_list:null},
    controller:'allYudingOrderCtrl'
    })
    .state('schedulePage',{
    ...
    .state('changePassword',{
      ...
      .state('offlineOrderInfo',{
        ...
        params:{orderinfo:null,paramsJson:null},
        templateUrl:'offlineOrderInfo.html',
        controller:'offlineOrderInfoCtrl'
      })
      .state('orderDetail',{
        url:'orderDetail',
        params:{id:null,type:null,wtype:null},
      ...
      .state('orderTabs',{
        url:'orderTabs',
        params:{dangqi:null,index:null},
        templateUrl:'templates/sdjg/orderTabs.html',
        controller:'orderTabsCtrl'
      })
      .state('jgAllOrders',{
        url:'/jgAllOrders',
        templateUrl:'templates/sdjg/jgAllOrders.html',
        controller:'jgAllOrdersCtrl'
      })
      .state('jgCanceledOrders',{
        url:'/jgCanceledOrders',
        templateUrl:'jgCanceledOrders.html',
        controller:'jgCanceledOrdersCtrl'
      })
      ...
      .state('activityPage',{
        url:'activityPage',
        templateUrl:'templates/sdjg/activityPage.html',
      ...
      .state('hcMainOrder',{
        url:'/hcMainOrder',
        templateUrl:'templates/hc/hcMainOrder.html',
        controller:'hcMainOrderCtrl'
      })
      .state('hcOrderDetail',{
        url:'/hcOrderDetail',
        params:{id:null,type:null,wtype:null},
        templateUrl:'templates/hc/hcOrderDetail.html',
        controller:'hcOrderDetailCtrl'
      })
      .state('hcAccountCenter',{
        url:'/hcAccountCenter',
        templateUrl:'templates/hc/hcAccountCenter.html',
        controller:'hcAccountCenterCtrl'
      })
      .state('hcAccountCenterDetail',{
        url:'hcAccountCenterDetail',
        templateUrl:'hcAccountCenterDetail.html',
        controller:'hcAccountCenterDetailCtrl'
      })
      .state('hcCalendar',{
        url:'/hcCalendar',
        templateUrl:'templates/hc/hcCalendar.html',
        controller:'hcCalendarCtrl'
      })
      .state('hcAddOrder',{
        url:'/hcAddOrder',
        templateUrl:'hcAddOrder.html',
        controller:'hcAddOrderCtrl'
      })
      .state('hc_offlineOrderInfo',{
        url:'/hc_offlineOrderInfo',
        params:{orderinfo:null,paramsJson:null},
        templateUrl:'hc_offlineOrderInfo.html',
        controller:'hc_offlineOrderInfoCtrl'
      })
      .state('hcOrderTabs',{
        url:'/hcOrderTabs',
        params:{dangqi:null,index:null},
        templateUrl:'templates/hc/hcOrderTabs.html',
        controller:'hcOrderTabsCtrl'
      })
      .state('hcActivityPage',{
        url:'/hcActivityPage',
        templateUrl:'templates/hc/hcActivityPage.html',
        controller:'hcActivityCtrl'
      })
      .state('hcActivityAdd',{
        url:'hcActivityAdd',
        templateUrl:'hcActivityAdd.html',
        controller:'hcActivityAddCtrl'
      })
      .state('hcActivityEdit',{
        url:'/hcActivityEdit/:id',
        templateUrl:'hcActivityEdit.html',
        controller:'hcActivityEditCtrl'
      })
      .state('hcAllOrders',{
        url:'/hcAllOrders',
        templateUrl:'templates/hc/hcAllOrders.html',
        controller:'hcAllOrdersCtrl'
      })
      .state('hcCanceledOrders',{
        url:'/hcCanceledOrders',
        templateUrl:'hcCanceledOrders.html',
        controller:'hcCanceledOrdersCtrl'
      })
      .state('hcCompletedOrders',{
        url:'/hcCompletedOrders',
        templateUrl:'templates/hc/hcCompletedOrder-tabs.html',
        controller:'hcCompletedOrdersCtrl'
      })
      .state('hcCompletedOrderDetail',{
        url:'/hcCompletedOrderDetail',
        params:{id:null,type:null},
        templateUrl:'templates/hc/hcCompletedOrderDetail.html',
        controller:'hcCompletedOrderDetailCtrl'
      })
      .state('contactUs',{
        url:'contactUs',
